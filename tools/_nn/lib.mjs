/* _nn/lib.mjs — my own boot harness (verify judge #13). Serves the repo
   over http, boots the real game in headless Chrome with WebGL2. */
...
export async function boot(opts = {}) {
  const { query = '?skipIntro', width = 1280, height = 720, wait = 3500, dpr = 1 } = opts;
...
export const P = (l, o) => console.log(l + ' ' + JSON.stringify(o));
