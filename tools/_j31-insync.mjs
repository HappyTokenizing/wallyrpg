#!/usr/bin/env node
/* _j31-insync.mjs — JUDGE 31. inSync at five desktop shapes AND on a
...
const SHAPES = [
  { w: 1600, h: 900, dsf: 2, phone: false },
  { w: 1440, h: 900, dsf: 2, phone: false },
  { w: 1366, h: 768, dsf: 2, phone: false },
  { w: 1280, h: 800, dsf: 2, phone: false },
  { w: 1194, h: 834, dsf: 2, phone: false },
  { w: 390,  h: 844, dsf: 3, phone: true  },
];
const F = (s, n) => String(s).padEnd(n);

console.log('# _j31-insync — headless Chrome channel=chrome, ANGLE Metal, M1 Max. Governor takes its own notch (3x governorStep, no override).');
