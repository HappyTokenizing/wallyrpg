/* _jj/lib.mjs — my own harness. Serves the repo, boots the real game in
   headless chrome with WebGL2, hands back { page, browser, close }. */
...
export const P = (label, o) => console.log(label + ' ' + JSON.stringify(o));
